...
d=$(date +%F)
t=$(date +%H:%M:%S)
bash wget.sh "http://www.marathonbet.com/ru/results.htm?form_name=form&Football=on&dateFilterSelector=RANGE&fromDate=16.10.2013&toDate=16.10.2013&submit=%D0%9F%D0%BE%D0%BA%D0%B0%D0%B7%D0%B0%D1%82%D1%8C" tmp1
